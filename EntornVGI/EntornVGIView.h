...
public:
	...
	afx_msg void OnKeyDownForRobot(UINT nChar, UINT nRepCnt, UINT nFlags);
	...
	afx_msg void OnProjeccioOrthogonal();
	afx_msg void OnUpdateProjeccioOrthogonal(CCmdUI *pCmdUI);
	afx_msg void OnProjeccioAxonometric();
	afx_msg void OnUpdateProjeccioAxonometric(CCmdUI *pCmdUI);
	...
	afx_msg void OnWristXpositiveRotation();
	afx_msg void OnWristXnegetiveRotation();
	afx_msg void OnWristYpositiveRotation();
